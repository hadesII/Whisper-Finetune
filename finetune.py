...
add_arg("use_lora",   type=bool,   default=False, help="是否使用Lora")
...
if (args.use_lora or args.use_adalora) and (training_args.local_rank == 0 or training_args.local_rank == -1):
    print('=' * 90)
